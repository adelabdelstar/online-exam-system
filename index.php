...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter student name" class="form-control input-md" type="text" value="<?php
if (isset($_GET['name']))
{
echo $_GET['name'];
}?>" required>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select id="gender" name="gender" placeholder="Select gender" class="form-control input-md" required >
   <option value="" <?php
...
<!-- Text input-->
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter  stcode no (Ex.732116104***)" class="form-control input-md" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="phno" name="phno" placeholder="Enter mobile number" class="form-control input-md" type="number" value="<?php
if (isset($_GET['phno']))
{
echo $_GET['phno'];
}
...
<div class="form-group">
  ...
  <div class="col-md-12" style="text-align: center"> 
    <input  type="submit" value=" Sign Up" class="btn btn-primary" style="text-align:center" />
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:darkblue;font-size:12px;font-weight: bold">Login </span></h4>
      </div>
